...
class TransactionManager(object):
    ...
    def add_transaction(self,transaction):
        ...
        self.__transaction[self.__num_transaction]=transaction
    ...
    def calc_support(self,items):
        ...
        sum_indexes=0
        min_index, min_item = min(enumerate([len(self.__transaction_index_map[item]) for item in items]), key=operator.itemgetter(1))
        
        book=[0 for i in range(min_item)]
